			...
			<form class="mx-5" id="DoctorForm" action="DoctorServlet" method="post">
				<div class="modal-body">
						...
						<div class="col-sm-9 my-auto">
							<div class="form-check-inline">
						      <label class="form-check-label" for="inputGender">
						        <input type="radio" class="form-check-input" id="male" name="inputGender" 
						        		value="Male" checked>Male
						      </label>
						    </div>
						    <div class="form-check-inline">
						      <label class="form-check-label" for="inputGender">
						        <input type="radio" class="form-check-input" id="female" name="inputGender" 
						        		value="Female">Female
						      </label>
						    </div>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="inputQual" id="inputQual" 
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" name="inputExpertIn" id="inputExpertIn" 
